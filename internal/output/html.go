...
<head>
    ...
    <title>{{.Name}} - Chiperka Test Report</title>
    ...
    <div class="container">
        <div class="header">
            <div class="brand">
                ...
                <span class="brand-text">Chiperka Test Report</span>
        ...
        <div class="footer">Generated by Chiperka Test Runner{{if .GeneratedAt}} &middot; {{.GeneratedAt}}{{end}}</div>
    </div>
</body>
</html>
`
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Chiperka Test Report</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">
    <style>
...
<body>
    <div class="container">
        ...
        <div class="footer">Generated by Chiperka Test Runner{{if and .Version (ne .Version "dev")}} v{{.Version}}{{end}} &middot; {{.GeneratedAt}}</div>
    </div>
</body>
</html>
`
